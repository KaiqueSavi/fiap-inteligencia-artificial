...
def exibir_cabecalho_tabela():
    ...
    print(
        f"{'ID':<4}{'NOME':<20}{'ÁREA(ha)':>10}{'TIPO':>12}"
...
def exibir_dashboard(talhoes):
    ...
    # Imprime totais.
    print(
        f"TOTAIS: área={total_area:.2f} ha | esperado={total_esperado:.2f} t | "
    ...
    print(
        f"PIOR TALHÃO: {cor_pior}{pior['nome']} "
